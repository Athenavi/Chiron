...
const menuItems = computed<MenuItem[]>(() => {
  const items: MenuItem[] = [
    ...
    { key: '/workflow', label: '工作台', icon: () => h(ApartmentOutlined) },
...
const dockItems: DockItem[] = [
  ...
  { key: '/workflow', label: '工作台', desc: 'DAG 流程编排', icon: ApartmentOutlined },
  { key: '/skills', label: '技能', desc: '工具 MCP', icon: ThunderboltOutlined },
  { key: '/knowledge', label: '知识', desc: 'RAG 检索增强', icon: BookOutlined },
