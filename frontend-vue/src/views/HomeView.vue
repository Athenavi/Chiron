...
const features: Feature[] = [
  { title: '对话', en: 'CHAT', desc: '常规 / 极简 / PTC / 创意四种模式，工具调用全程可视化', path: '/chat', icon: markRaw(MessageOutlined) },
...
<template>
  <div class="home">
    ...
    <section class="hero">
      ...
      <div class="hero-content">
        <span class="hero-badge">
          <span class="hero-badge-dot" />chiron · 自托管 AI Agent 控制台
        </span>
        <h1 class="hero-title">
          让 Agent
      ...
      <div class="showcase-grid">
        ...
        <div class="window-card">
          <div class="window-chrome">
            ...
            <span class="win-title">chiron · 对话</span>
          </div>
    ...
    <footer class="home-footer">
      ...
      <span class="home-footer-note">自托管 · 开源 · 你的数据留在你的机器中</span>
    </footer>
