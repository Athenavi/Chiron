      ...
      >
        <div class="status-grid">
          ...
          >
            ...
            <DescriptionsItem label="Redis 延迟">
              {{ gatewayStatus.redisLatency }}ms
            </DescriptionsItem>
            <DescriptionsItem label="DB 延迟">
