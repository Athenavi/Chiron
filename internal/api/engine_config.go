...
// internalTokenMW 鏍￠獙 X-Internal-Token锛屼緵 Go 缃戝叧鍐呴儴绔偣锛堝紩鎿庨厤缃笅鍙戯級浣跨敤銆?// 缂哄け/涓嶅尮閰嶆椂杩斿洖 401锛岀粷涓嶉€忓嚭瑙ｅ瘑鍚庣殑鏁忔劅閰嶇疆銆
...
// 渚?Python AI 寮曟搸鍚姩鏃舵媺鍙栥€宲ython銆嶅垎绫荤殑鍚庡彴閰嶇疆锛堟晱鎰熼敭宸茬敱 APP_SECRET 瑙ｅ瘑锛夈€?// 浠呮帴鍙楀甫 X-Internal-Token 鐨勫唴閮ㄨ皟鐢紝闃叉閰嶇疆澶栨硠銆
