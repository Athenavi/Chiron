...
// signMediaURL 涓鸿祫浜х敓鎴愮鍚嶄笅杞?URL锛堟牎楠屽綊灞炲悗绛惧彂锛夈€
...
// SignMedia POST /v1/media/{id}/sign 鈥斺€?閴存潈鍚庣鍙戠鍚?URL銆
...
// ServeSignedMedia GET /media/s/{assetID}?exp=&sig= 鈥斺€?鏍￠獙绛惧悕鍚庢祦寮忚繑鍥炴枃浠躲€
...
// mediaRoot 杩斿洖濯掍綋瀛樺偍鏍癸紙涓庤矾鐢辨敞鍐屾椂 FileServer 鍚屾簮锛夈€
