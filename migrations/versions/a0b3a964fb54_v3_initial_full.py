...
Revision ID: a0b3a964fb54
Revises: 
Create Date: 2026-09-09 23:29:13.378251
...
def upgrade() -> None:
    ...
    # llm_provider_keys — 管理端 LLM provider 密钥(网关本地原生 SQL 实现,无 ORM 模型,
    # 由原 b2e4 手工迁移并入基线,保证全新库可用)
